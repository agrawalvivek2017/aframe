    ...
    AFRAME.registerComponent("event-set", {
        schema: {
            ...
            parse: function(e) {
                ...
                t = {};
                for (i in s)
                    r = i.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase(),
                    t[r] = s[i];
                return t
            }
        },
        ...
        updateEventListener: function() {
            ...
            delete r._event,
            delete r._target,
            n = t ? i.sceneEl.querySelector(t) : i,
            this.eventName = e,
            this.eventHandler = function() {
                var e;
                for (e in r)
                    AFRAME.utils.entity.setComponentProperty.call(this, n, e, r[e])
            }
        },
